...
<section>
    ...
    <div class="container" style="margin-top:2.5rem; margin-bottom:5rem;">
        ...
        <div class="row" style="margin-left:2rem;margin-top:3rem;">
            ...
            <div class="col-md-7" style="padding-left:1rem;padding-right:5rem; color: rgba(14, 162, 154,1);">
                ...
                <div style="font-family:'Lato-LightItalic';">
                    <p>
                        ...
                        <img src="{{ asset('img/icon/icon-glutenperola.png') }}" style="height:1.5rem;" alt="">
                        @endif
                        {!! $tipoproduto->texto!!}
                    ...
                    <div class="row" style="font-family: 'Lato-Regular'; margin-top: 3rem;">
                        @if (!is_null($tipoproduto->preparacao))
                            <div class="col-md-6" style="display:flex">
                                    <img src="{{ asset('img/icon/icon-chefperola.png') }}" style="height: 1.5rem;margin-top:2px" alt="Chef Icon">
                        ...
                        @endif
                        <div class="col-md-6" style="display:flex">
                            <img src="{{ asset('img/icon/icon-caixaperola.png') }}" style="height: 1.5rem;margin-top:2px" alt="Box Icon">
                            <p style="padding-left:10px">
                    ...
                    <div class="row" style="font-family: 'Lato-Regular'; margin-top: 1rem;">
                        ...
                        @if (!is_null($tipoproduto->balanca))
                            <div class="col-md-6 " style="display:flex">
                                <img src="{{ asset('img/icon/icon-balancaperola.png') }}" style="height: 1.5rem;margin-top:2px" alt="Box Icon">
                                <p style="padding-left:10px">
            ...
            <div class="portfolio-i row" style="/*margin-left:1rem;*//*margin-right:1rem;*/">
                ...
                <div class="ite prod0 col-md-2" style="text-align:center;">
                    <a href="{{route('produto', $prod->id)}}" style="text-decoration:none !important;">
                        ...
                        <h6 style=" color:rgba(25, 175, 158,1);margin-top:1rem;margin-bottom:3rem;">{{$prod->nome}}
                        </h6>
                    </a>
                </div>
                @endforeach
            ...
            <div class="row justify-content-center" style="text-align: center;margin-top:5rem;">
                <div class="portfolio-menu mt-2 mb-4 ">
                    <ul class="linha d-flex justify-content-center"
                        style="border-bottom:2px solid rgba(25, 175, 158,0.4);padding-right: 2rem;">
