    ...
    <section style="margin-top: 5rem;">
        ...
        <div class="row justify-content-center  d-flex align-items-center">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 justify-content-center  d-flex align-items-center"
                style="width:22rem !important;height:18rem !important; background: linear-gradient(50deg, rgba(249,198,86,1) 0%, rgba(252,162,103,1) 14%, rgba(202,40,65,1) 35%, rgba(215,53,136,1) 55%, rgba(77,40,93,1) 80%, rgba(14,162,154,1) 100%);">
                <div>
                    <h2 style="color:white;font-family: 'Adam-Medium';">DREAM</h2>
                    <h2 style="color:white;font-family: 'Adam-Medium';">AMAZE</h2>
                    <h2 style="color:white;font-family: 'Adam-Medium';">REPEAT</h2>
                </div>
            </div>
        </div>
