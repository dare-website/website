...
<section class="">
    ...
    <section class="section swiper-container swiper-slider swiper-slider-corporate swiper-pagination-style-2"
        data-loop="true" data-autoplay="6800" data-simulate-touch="true" data-nav="false" data-direction="horizontal">
        <div class="swiper-wrapper text-left">
            <div class="versa1 swiper-slide context-dark"
                style="background-image: url('video/video 1.gif');background-size:cover;">
