                ...
                <div style="font-family:'Lato-LightItalic';">
                    ...
                    <div class="row" style="font-family: 'Lato-Regular'; margin-top: 3rem;">
                        <div class="col-md-6" style="display:flex">
                                <img src="{{ asset('img/icon/icon-chefsemi.png') }}" style="height: 1.5rem;margin-top:2px" alt="Chef Icon">
                        ...
                        <div class="col-md-6" style="display:flex">
                            <img src="{{ asset('img/icon/icon-caixasemi.png') }}" style="height: 1.5rem;margin-top:2px" alt="Box Icon">
                            <p style="padding-left:10px">
                        ...
                        @if (!is_null($tipoproduto->balanca))
                            <div class="col-md-6 offset-md-6" style="display:flex">
                                <img src="{{ asset('img/icon/icon-balancasemi.png') }}" style="height: 1.5rem;margin-top:2px" alt="Box Icon">
                                <p style="padding-left:10px">
            ...
            <div class="row" style="text-align: center;margin-top:5rem;">
                <div class="portfolio-menu mt-2 mb-4 ">
                    <ul class="linha d-flex justify-content-center"
                        style="border-bottom:2px solid rgba(217, 53, 138,0.4);padding-right: 2rem;">
...
<footer class="text-center text-lg-start text-white footer-16371" id="contacto" style="background-color:  #d9358a;">
                ...
                <div class="col-md-5 col-lg-5 col-xl-5 mt-3 text-black footer-newsletter">
                    ...
                    <div style="">
                        <form action="/news" method="post">
                            ...
                            <input style="background: #d9358a;" type="submit" value="{{__('messages.sub')}}">
                        </form>
                    </div>
    ...
    <!-- Copyright -->
    <div class="font1 text-center text-white "
        style="padding-bottom:0.5rem;padding-top:0.5rem; background-color:  #d9358a">
