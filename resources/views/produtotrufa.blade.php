...
<section>
    ...
    <div class="container" style="margin-top:2.5rem; margin-bottom:5rem;">
            ...
            <div class="col-lg-12 text-center my-2">
                <div class="row">
                    <div class="col-md-6" style="text-align: left;">
                        <h6 style="font-family: 'Raleway-Medium';color: rgba(113, 35, 35, 0.5);margin-left:2rem;"> <a
                                style="text-decoration: none; color: rgba(	113, 35, 35,0.5) !important;"
                                href="/">HOME</a> /
                            <a style="text-decoration: none; color: rgba(	113, 35, 35,0.5) !important;"
        ...
        <div class="row" style="margin-left:2rem;margin-top:3rem;">
            ...
            <div class="col-md-7" style="padding-left:1rem;padding-right:5rem; color: #712323;">
                ...
                <div style="font-family:'Lato-LightItalic';">
                    <p>
                        ...
                        <img src="{{ asset('img/icon/icon-glutenfreetrufa.png') }}" style="height:1.5rem;" alt="">
                        @endif
                        {!! $tipoproduto->texto!!}
                    ...
                    <div class="row" style="font-family: 'Lato-Regular'; margin-top: 3rem;">
                        @if (!is_null($tipoproduto->preparacao))
                            <div class="col-md-6" style="display:flex">
                                    <img src="{{ asset('img/icon/icon-cheftrufa.png') }}" style="height: 1.5rem;margin-top:2px" alt="Chef Icon">
                        ...
                        @endif
                        <div class="col-md-6" style="display:flex">
                            <img src="{{ asset('img/icon/icon-caixatrufa.png') }}" style="height: 1.5rem;margin-top:2px" alt="Box Icon">
                            <p style="padding-left:10px">
                        ...
                        @if (!is_null($tipoproduto->balanca))
                            <div class="col-md-6 " style="display:flex">
                                @if(Str::contains($tipoproduto->balanca, 'ml') || Str::contains($tipoproduto->balanca, 'l') || Str::contains($tipoproduto->balanca, 'dl'))
                                    <img src="{{ asset('img/icon/icon-gotatrufa.png') }}" style="height: 1.5rem;margin-top:2px" alt="Box Icon">
                                    
                                @else
                                    <img src="{{ asset('img/icon/icon-balancatrufa.png') }}" style="height: 1.5rem;margin-top:2px" alt="Box Icon">
                                @endif
                                <p style="padding-left:10px">
            ...
            <div class="portfolio-i row" style="/*margin-left:1rem;*//*margin-right:1rem;*/">
                ...
                <div class="ite prod0 col-md-2" style="text-align:center;">
                    <a href="{{route('produto', $prod->id)}}" style="text-decoration:none !important;">
                        ...
                        <h6 style=" color:#712323;margin-top:1rem;margin-bottom:3rem;">{{$prod->nome}}</h6>
                    </a>
                </div>
                @endforeach
            </div>
                ...
                <div class="portfolio-i row d-flex justify-content-center">
                    ...
                    <div class="ite prod0 col-md-3" style="text-align:center;">
                        <a href="<?php if($prodR->id_tipo == 3 || $prodR->id_tipo == 4){ echo route('produto', $prodR->id); }else{  echo route('produto', $prodR->id) ; }?>"
                            ...
                            <h6
                                style="font-family: 'Raleway-Medium';color:#712323;margin-top:1rem;margin-bottom:3rem;">
                                {{$prodR->nome}}
                            </h6>
                        </a>
                    </div>
        ...
        .btn1:active,
        .btn1:hover {
            color: rgba(	113, 35, 35,1);
            border-radius: 0px !important;
            --bs-btn1-border-color: none;
            border-bottom: 2px solid rgba(	113, 35, 35,1) !important;
        }
        </style>


</section>
<footer class="text-center text-lg-start text-white footer-16371" id="contacto" style="background-color:#712323 ;">
    <!-- Grid container -->
    ...
    <div class="font1 text-center text-white "
        style="margin-top:2rem;padding-bottom:0.5rem;padding-top:0.5rem; background-color: #712323">
        <h6 style="font-size:0.6rem;"><a style="color:white" href="/politica-privacidade">Politica de Privacidade</a>
        </h6>
    </div>
    <!-- Copyright -->
    <div class="font1 text-center text-white "
        style="padding-bottom:0.5rem;padding-top:0.5rem; background-color: #712323">
